...
- Arquivolta installs via the [Arquivolta Installer](https://github.com/arquivolta/desktop/releases/tag/v0.4.0), a Windows 11 app that installs everything for you, using your Windows install to answer all of the reduntant questions that other distros ask users.
